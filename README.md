# HBR IDK BRASIL THEME - WordPress template by IDK Media

This WordPress template was developed and is maintained by <a href="https://idkbrasil.com/" target="_blank">IDK Brasil</a>.

## Getting started

This repository does usage of the basic WordPress features, but with modified structure. It also uses the power of Tailwind CSS to better maintain code readability and reliability through multiple developers.
